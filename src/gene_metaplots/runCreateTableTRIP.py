...
peakList = [pn+"count_gene_trip.txt", pn+"count_gene_wt.txt", pn+"count_intron_trip.txt", pn+"count_intron_wt.txt", pn+"counts_intron_single_trip.txt", pn+"counts_intron_single_wt.txt"]
outLoc = "/home/egg/Projects/Roukos_Bliss/Results/7_facrna_corr/tables/TRIP/"
...
for featurePeakFileName in peakList:
  ...
  bamList = [bn+"TK6_TRIP_DMSO.bam", bn+"TK6_TRIP_ETO.bam", bn+"TK6_wt_DMSO.bam", bn+"TK6_wt_ETO.bam"]
  bamCountList = [6653132, 10431314, 6715854, 1765410]
