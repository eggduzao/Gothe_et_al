...
def main():
  ...
  parser.add_option("--region-type", dest="region_type", type="int", metavar="INT", default=0, help=("Placeholder."))
  parser.add_option("--alias-file", dest="alias_file_name", type="string", metavar="FILE", default=None, help=("Placeholder."))
  parser.add_option("--gene-file", dest="gene_file_name", type="string", metavar="FILE", default=None, help=("Placeholder."))
  parser.add_option("--ctcf-file", dest="ctcf_file_name", type="string", metavar="FILE", default=None, help=("Placeholder."))
  parser.add_option("--expression-file", dest="expression_file_name", type="string", metavar="FILE", default=None, help=("Placeholder."))
  parser.add_option("--dsb-file", dest="dsb_file_name", type="string", metavar="FILE", default=None, help=("Placeholder."))
  parser.add_option("--output-file", dest="output_file_name", type="string", metavar="FILE", default=None, help=("Placeholder."))
  ...
  if(not region_type): pass
  if(not ctcf_resolution): pass
  if(not percentile_list): pass
  if(not alias_file_name): pass
  if(not gene_file_name): pass
  if(not ctcf_file_name): pass
  if(not bam_list): pass
  if(not expression_file_name): pass
  if(not output_file_name): pass
